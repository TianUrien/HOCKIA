      ...
      <div className="flex items-center gap-2 px-4 py-3">
        ...
        {canExpand && (
          <button
            ...
            className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-full border border-gray-200 text-gray-400 hover:border-[#8026FA]/40 hover:text-[#8026FA] transition-colors"
          >
            <ChevronDown
