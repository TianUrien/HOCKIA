  ...
  return (
    <div className="bg-white border-t-4 border-t-indigo-500">
      <div className="p-5">
        ...
        {/* CTA — labelled "View Profile" for consistency with the other
            actor-focused feed cards (MilestoneCard, MemberJoinedCard,
            SigningAnnouncementCard, TransferAnnouncementCard). The
            destination is the receiver's profile, where the full
            reference + endorsement text live. */}
