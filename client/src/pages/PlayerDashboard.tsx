        ...
        {readOnly && !isOwnProfile && (
          <ScoutingCard
            profile={{
              ...
              relocation_willingness: (profile as Profile).relocation_willingness ?? null,
              relocation_countries_open: (profile as Profile).relocation_countries_open ?? null,
              relocation_countries_excluded: (profile as Profile).relocation_countries_excluded ?? null,
              level_target: (profile as Profile).level_target ?? null,
