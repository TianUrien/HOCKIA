        ...
        {readOnly && !isOwnProfile && isLanding && (
          <ScoutingCard
            profile={{
              ...
              relocation_willingness: (profile as { relocation_willingness?: string | null }).relocation_willingness ?? null,
              relocation_countries_open: (profile as { relocation_countries_open?: number[] | null }).relocation_countries_open ?? null,
              relocation_countries_excluded: (profile as { relocation_countries_excluded?: number[] | null }).relocation_countries_excluded ?? null,
              level_target: (profile as { level_target?: string | null }).level_target ?? null,
