...
import { analyticsContext } from '@/lib/analyticsIdentity'
...
/** @deprecated Use submitSignupAttribution from lib/attribution. Kept so
 *  existing call sites keep compiling; delegates to the v2 engine. */
